...
public enum SimpleAuth {
    ...
    public static func duplicateRight(
        ...
        // Custom rights are bound to the caller by Authorization Services.
        // ChargeWattMenu prepares this right in the app process before XPC calls.
        _ = requesterIdentifier
